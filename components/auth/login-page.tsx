...
import { Loader2, Bot, Users, MessageSquare } from "lucide-react"
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4 animate-in fade-in-0 slide-in-from-bottom-4 duration-700">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg mt-2">Collaborate with AI and your team</p>
          </div>
        </div>
        ...
        <Card className="shadow-xl animate-in fade-in-0 slide-in-from-bottom-4 duration-700 delay-300">
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to start collaborating with AI and your team</CardDescription>
          </CardHeader>
